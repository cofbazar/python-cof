...
cloaks = {
    ...
    'others': {
        'protective-cloak': {
            ...
            'special_property': [],
            'base_item': 'protective-cloak',
            'exclude': ['protective-cloak'],
            'magical_level': 0,
            'name': "Cape",
            'short_description': "Cape de protection.",
            'full_description': "Le bonus de la cape de protection ne se cumule pas avec le bonus des anneaux de "
                                "protection.",
    ...
    'flavors': {
        'magical': {
            ...
            'short_description': lambda item, magical_level: "{} Cette cape est magique et offre un bonus en DEF "
                                                             "de +{}.".format(item.short_description,
                                                                              magical_level),
            'full_description': lambda item, magical_level: "{} Cette cape est magique et offre un bonus en DEF "
                                                            "de +{}.".format(
        ...
        'defense': {
            ...
            'short_description': lambda item, magical_level: "{} Cette cape réduit de 2 tous les DM subits.".format(
                item.short_description),
            'full_description': lambda item, magical_level: "{} Cette cape réduit de 2 tous les DM subits.".format(
        ...
        'higher-defense': {
            ...
            'short_description': lambda item, magical_level: "{} Cette cape réduit de 4 tous les DM subits.".format(
                item.short_description),
            'full_description': lambda item, magical_level: "{} Cette cape réduit de 4 tous les DM subits.".format(
                item.full_description),
        ...
        'swimming': {
            ...
            'short_description': lambda item, magical_level: "{} Cette cape apporte un bonus de +5 aux test de "
                                                             "natation.".format(item.short_description),
            'full_description': lambda item, magical_level: "{} Cette cape apporte un bonus de +5 aux test de "
        ...
        'shadow': {
            ...
            'short_description': lambda item, magical_level: "{} Cette cape apporte un bonus +5 aux test de "
                                                             "discrétion.".format(item.short_description),
            'full_description': lambda item, magical_level: "{} Cette cape apporte un bonus +5 aux test de discrétion "
        ...
        'protective': {
            ...
            'short_description': lambda item, magical_level: "{} Cette cape réduit les dégats critiques".format(
                item.short_description),
            'full_description': lambda item, magical_level: "{} Cette cape divise par 2 les DM des coups critiques et "
        ...
        'magical-resistance': {
            #'exclude': ['protective-cloak-magical+{}'.format(level) for level in [1, 2, 3, 4]],
            'category': lambda item, magical_level: 'Magique',
            'material': lambda item, magical_level: item.material,
            ...
            'short_description': lambda item, magical_level: "{} Cette cape apporte un bonus de +5 en DEF pour "
                                                             "résister à la magie.".format(
                item.short_description),
            'full_description': lambda item, magical_level: "{} Cette cape apporte un bonnus de +5 en DEF ou aux tests "
        ...
        'fire-resistance': {
            ...
            'short_description': lambda item, magical_level: "{} Cette cape permet de réduire de 10 DM les dếgats "
                                                             "occasionnés par le feu.".format(
                item.short_description),
            'full_description': lambda item, magical_level: "{} Cette cape permet de réduire de 10 DM les dếgats "
                                                            "occasionnés par le feu.".format(
                item.full_description),
