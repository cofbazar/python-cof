...
rings = {
    ...
    'others': {
        'protective-ring': {
            ...
            'special_property': [],
            'base_item': 'protective-ring',
            'exclude': ['protective-ring'],
            'magical_level': 0,
            'name': "Anneau",
            'short_description': "Anneau de protection.",
            'full_description': "Le bonus de l'anneau de protection ne se cumule pas avec le bonus des capes de "
                                "protection.",
    ...
    'flavors': {
        'magical': {
            ...
            'short_description': lambda item, magical_level: "{} Cet anneau est magique et offre un bonus en DEF "
                                                             "de +{}.".format(item.short_description,
                                                                              magical_level),
            'full_description': lambda item, magical_level: "{} Cet anneau est magique et offre un bonus en DEF "
                                                            "de +{}.".format(
        ...
        'defense': {
            ...
            'short_description': lambda item, magical_level: "{} Cet anneau réduit de 2 tous les DM subits.".format(
                item.short_description),
            'full_description': lambda item, magical_level: "{} Cet anneau réduit de 2 tous les DM subits.".format(
        ...
        'higher-defense': {
            ...
            'short_description': lambda item, magical_level: "{} Cet anneau réduit de 4 tous les DM subits.".format(
                item.short_description),
            'full_description': lambda item, magical_level: "{} Cet anneau réduit de 4 tous les DM subits.".format(
                item.full_description),
        ...
        'swimming': {
            ...
            'short_description': lambda item, magical_level: "{} Cet anneau apporte un bonus de +5 aux test de "
                                                             "natation.".format(item.short_description),
            'full_description': lambda item, magical_level: "{} Cet anneau apporte un bonus de +5 aux test de "
        ...
        'shadow': {
            ...
            'short_description': lambda item, magical_level: "{} Cet anneau apporte un bonus +5 aux test de "
                                                             "discrétion.".format(item.short_description),
            'full_description': lambda item, magical_level: "{} Cet anneau apporte un bonus +5 aux test de discrétion "
        ...
        'protective': {
            ...
            'short_description': lambda item, magical_level: "{} Cet anneau réduit les dégats critiques".format(
                item.short_description),
            'full_description': lambda item, magical_level: "{} Cet anneau divise par 2 les DM des coups critiques et "
        ...
        'magical-resistance': {
            #'exclude': ['protective-ring-magical+{}'.format(level) for level in [1, 2, 3, 4]],
            'category': lambda item, magical_level: 'Magique',
            'material': lambda item, magical_level: item.material,
            ...
            'short_description': lambda item, magical_level: "{} Cet anneau apporte un bonus de +5 en DEF pour "
                                                             "résister à la magie.".format(
                item.short_description),
            'full_description': lambda item, magical_level: "{} Cet anneau apporte un bonnus de +5 en DEF ou aux tests "
        ...
        'fire-resistance': {
            ...
            'short_description': lambda item, magical_level: "{} Cet anneau permet de réduire de 10 DM les dếgats "
                                                             "occasionnés par le feu.".format(
                item.short_description),
            'full_description': lambda item, magical_level: "{} Cet anneau permet de réduire de 10 DM les dếgats "
                                                            "occasionnés par le feu.".format(
                item.full_description),
