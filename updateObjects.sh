...
case "$1" in
	spell)
		python3 cofCapacitiesUpdate.py && python3 cofDrsSpellsAndMagicalWandsImport.py && cp data/*.json ../../cofbazar.github.io/data/
		;;
	potion)
		python3 cofCapacitiesUpdate.py && python3 cofDrsPotionsImport.py && cp data/*.json ../../cofbazar.github.io/data/
		;;
